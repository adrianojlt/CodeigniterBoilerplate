...
class FuelMenu {
	...
	public $first_class = ''; // the css class for the first menu item
	public $last_class = '';  // the css class for the last menu item
...
/* Location: ./application/libraries/FuelMenu.php */